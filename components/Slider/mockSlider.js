const mockSlider = [
  {
    ...
    image:
      'https://coingeek.com/wp-content/uploads/2020/01/taal-lowers-bitcoin-sv-transaction-fees-to-support-enterprise-blockchain-applications.jpg',
    subTitle:
      "Taal Distributed Information Technologies Inc. is pleased to announce that it will be implementing the following changes to transaction fees charged by its cloud computing operations on the Bitcoin SV ('BSV') network.",
    url:
